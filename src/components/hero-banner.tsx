...
export default function HeroBanner() {
  return (
    <section id="home">
      <img src="/caminhao.svg" alt="Caminhao SVG" />
      <div className="lg:flex items-center xl:-mt-56 2xl:-mt-72">
        <div className="text-center lg:text-start flex flex-col items-center lg:items-start gap-6 mt-8 px-7 xl:px-16 2xl:pl-40">
          <h1 className="text-2xl lg:text-3xl xl:text-5xl leading-7 font-bold text-dark-gray">
            Soluções de{" "}
            <span className="text-yellow">
              Engenharia e Segurança do Trabalho.
            </span>
          </h1>
          <p className="text-sm xl:text-lg text-dark-gray">
        ...
        <img src="/assets/banner.png" alt="Banner BDM" className="lg:w-[40%]" />
      </div>
    </section>
  );
}
